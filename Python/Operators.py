...
1010 & 1001 = {"{:=04b}".format(   0b1010 & 0b1001   )} (AND)
1010 | 1001 = {"{:=04b}".format(   0b1010 | 0b1001   )} (OR)
1010 ^ 1001 = {"{:=04b}".format(   0b1010 ^ 0b1001   )} (XOR)
     ~ 1001 = {"{:=04b}".format((         ~ 0b1001   )+16)} (NOT)

111111 << 2 = {"{:=b}".format(   0b111111 << 2       )} (2桁左シフト)
111111 >> 2 = {"{:=b}".format(   0b111111 >> 2       )} (2桁右シフト)

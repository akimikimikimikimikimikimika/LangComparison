...
require_once("Classdef.php"); # クラス定義読み込み
# PHPにはインポート目的の関数として require,require_once,include,include_once という4種類の関数がある。includeではモジュール内のバグは警告されるのみだが,requireではエラーになる。そして,onceを付した関数は,同じモジュールを2度実行しないように (1度だけ実行する) ようにしたものである

...
func d2b(_ len: Int,_ dec:Int) -> String {
	let v=String(dec, radix: 2)
		let p=String(repeating: "0", count: max(len,v.count)-v.count)
		return p+v
}
let obj = NSObject()
...
1010 & 1001 = \(d2b(4,   b2d("1010") & b2d("1001")   )) (AND)
1010 | 1001 = \(d2b(4,   b2d("1010") | b2d("1001")   )) (OR)
1010 ^ 1001 = \(d2b(4,   b2d("1010") ^ b2d("1001")   )) (XOR)
      ~1001 = \(d2b(4,(               ~b2d("1001")   )+16)) (NOT)

111111 << 2 = \(d2b(0,   b2d("111111") << 2   )) (2桁左シフト)
111111 >> 2 = \(d2b(0,   b2d("111111") >> 2   )) (2桁右シフト)
